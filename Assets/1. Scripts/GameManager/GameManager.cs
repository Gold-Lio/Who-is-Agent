...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    private void Start()
    {
       ...
       ///* MyPlayer */ player = PhotonNetwork.Instantiate("Player", new Vector2(Random.Range(-17f, -13f), Random.Range(-47f, -50f)), Quaternion.identity).GetComponent<Player>();
       // Debug.Log("Player Create");
        

       // NetworkManager.NM.SetRandColor();
