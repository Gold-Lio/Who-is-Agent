...
public class IDScannerSlotUI : ItemSlotUI
{
    // 박스 구분 ID
    ...
    /// <param name="scannerid">스캐너 구분 ID</param>
    public void Initialize(uint newID, ItemSlot targetSlot, SlotType type, int scannerid)
    {
        slotType = type;
        scannerId = scannerid;
