...
public class NPCItemSlotUI : ItemSlotUI
{
    // 박스 구분 ID
    private int npcId = 0;
    // 박스 구분 ID 프로퍼티
    ...
    /// <param name="type">슬롯 타입 (Inven, Box, NPC, Temp)</param>
    /// <param name="npcid">박스 구분 ID</param>
    public void Initialize(uint newID, ItemSlot targetSlot, SlotType type, int npcid)
    {
        slotType = type;
        npcId = npcid;
        id = newID;
